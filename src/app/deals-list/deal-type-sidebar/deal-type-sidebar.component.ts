...
@Component({
    selector: 'app-deal-type-sidebar',
    imports: [CommonModule, NgOptimizedImage, RouterModule, RouterLink, NgbModule, NgbNavModule],
    templateUrl: './deal-type-sidebar.component.html',
    styleUrls: ['./deal-type-sidebar.component.scss']
})
export class DealTypeSidebarComponent implements OnInit {
  country: string = '';
  selectedCountry: any = '';
