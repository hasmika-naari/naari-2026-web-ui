...
import { FormControl, FormsModule, ReactiveFormsModule, 
          UntypedFormBuilder, UntypedFormGroup, Validators } from '@angular/forms';
import { MatDatepickerModule } from '@angular/material/datepicker';
import { MatFormFieldModule } from '@angular/material/form-field';
import { MatProgressBarModule } from '@angular/material/progress-bar';
import { MatSelectModule } from '@angular/material/select';
import { Brand, Category, DealDataItem, DealType } from '@app/services/deals.model';
import { Observable, Subscription } from 'rxjs';

@Component({
    selector: 'app-deal-details',
    imports: [CommonModule, MatProgressBarModule, FormsModule, MatFormFieldModule, MatDatepickerModule,
